...
return {
	...
	_: {
		client: {start:"_app/immutable/entry/start.zCE_GzY_.js",app:"_app/immutable/entry/app.CPy5pd8e.js",imports:["_app/immutable/entry/start.zCE_GzY_.js","_app/immutable/chunks/C-1yF2_a.js","_app/immutable/chunks/B3tR_vzS.js","_app/immutable/chunks/9E4dF-An.js","_app/immutable/entry/app.CPy5pd8e.js","_app/immutable/chunks/B3tR_vzS.js","_app/immutable/chunks/p0_JILK_.js","_app/immutable/chunks/LtqmgyD5.js","_app/immutable/chunks/DYOR36WO.js","_app/immutable/chunks/9E4dF-An.js","_app/immutable/chunks/Chkda7mK.js","_app/immutable/chunks/ZdaZVQ5c.js","_app/immutable/chunks/DVt25r4J.js"],stylesheets:[],fonts:[],uses_env_dynamic_public:false},
		nodes: [
		...
		routes: [
			...
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/boxscore/_eventId_/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/comments/_postId_/_server.ts.js'))
			},
			{
				id: "/api/reddit/debug",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/debug/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/debug/index/_server.ts.js'))
			},
			{
				id: "/api/reddit/index",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/index/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/index/fallback/_server.ts.js'))
			},
			{
				id: "/api/reddit/proxy",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/proxy/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/search/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/reddit/subreddit/_subreddit_/_server.ts.js'))
			},
			{
				id: "/api/scoreboard",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/scoreboard/_server.ts.js'))
			},
			{
				id: "/game/[id]",
				pattern: /^\/game\/([^/]+?)\/?$/,
